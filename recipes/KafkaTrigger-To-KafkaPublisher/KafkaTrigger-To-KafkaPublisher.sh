...
function testcase1 {
    ...
    sleep 2
    kafkaMessage="$(bin/kafka-console-consumer.sh --topic subscribepet --bootstrap-server localhost:9092 --timeout-ms 20000 --consumer.config $GOPATH/kafka/config/consumer.properties)"
