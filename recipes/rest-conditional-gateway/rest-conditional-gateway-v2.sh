...
function testcase1 {
$GOPATH/src/github.com/TIBCOSoftware/mashling-gateway/bin/mashling-gateway -config rest-conditional-gateway.json > /tmp/rest1.log 2>&1  &
pId=$!
sleep 15
...
function testcase2 {
$GOPATH/src/github.com/TIBCOSoftware/mashling-gateway/bin/mashling-gateway -config rest-conditional-gateway.json > /tmp/rest2.log 2>&1 &
pId=$!
sleep 15
